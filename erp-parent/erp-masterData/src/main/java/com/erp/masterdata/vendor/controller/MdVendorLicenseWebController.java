...
public class MdVendorLicenseWebController extends ControllerSupport {
  ...
  //    public String getMdVendorLicenseList(Pages pages, MdVendorLicenseCO mdVendorLicenseCO, Model
  // model) {
  //        //TODO: 分页查询数据
  //        if(pages.getPage()==0) {
  //            pages.setPage(1);
  ...
  // this.mdVendorLicenseService.getDataObjects(pages, mdVendorLicenseCO);
  //
  //        //页面属性设置
  ...
  public String editMdVendorLicense(
      @Valid MdVendorLicense mdVendorLicense,
  ...
  //    public String deleteMdVendorLicense(MdVendorLicense mdVendorLicense, RedirectAttributes
  // attr) {
  //        //TODO: 删除数据前验证数据
  //
  //        //删除数据
