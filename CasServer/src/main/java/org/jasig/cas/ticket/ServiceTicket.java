 ...
 * for a principal. A Service Ticket is generally a one-time use ticket.
 *
...
public interface ServiceTicket extends Ticket {
  ...
  /**
   * Method to grant a TicketGrantingTicket from this service to the authentication. Analogous to
  ...
  TicketGrantingTicket grantTicketGrantingTicket(
      String id, Authentication authentication, ExpirationPolicy expirationPolicy);
}
