...
public class FinVoucherLineWebController extends ControllerSupport {
  ...
  public String getFinVoucherLineList(Pages pages, FinVoucherLineCO finVoucherLineCO, Model model) {
    ...
    List<FinVoucherLine> finVoucherLineList =
        this.finVoucherLineService.getDataObjects(pages, finVoucherLineCO);
  ...
  public String editFinVoucherLine(
      @Valid FinVoucherLine finVoucherLine,
  ...
  public String deleteFinVoucherLine(
      FinVoucherLine finVoucherLine, String voucherHeadId, RedirectAttributes attr) {
    // 删除数据前验证数据
