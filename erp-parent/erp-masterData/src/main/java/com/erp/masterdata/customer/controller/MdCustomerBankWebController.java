...
public class MdCustomerBankWebController extends ControllerSupport {
  ...
  public String getMdCustomerBankList(Pages pages, MdCustomerBankCO mdCustomerBankCO, Model model) {
    ...
    // 分页查询数据
    List<MdCustomerBank> mdCustomerBankList =
        this.mdCustomerBankService.getBankListByCustomerCode(pages, mdCustomerBankCO);
  ...
  @ResponseBody
  public String editMdCustomerBank(
      @Valid @RequestBody MdCustomerBank mdCustomerBank,
  ...
  @ResponseBody
  public String deleteMdCustomerBank(
      @RequestBody MdCustomerBank mdCustomerBank, RedirectAttributes attr) {
    try {
      // 删除数据前验证数据
      if (mdCustomerBank != null && mdCustomerBank.getBankId() != null) {
        // 删除数据
