...
public class SoAgreementHeadApiController extends ControllerSupport {
  ...
  public String getSoAgreementHeadList(Pages pages, SoAgreementHeadCO soAgreementHeadCO) {
    ...
    // 分页查询数据
    List<SoAgreementHead> list =
        this.soAgreementHeadService.getDataObjects(pages, soAgreementHeadCO);
  ...
  public String editSoAgreementHead(
      @Valid SoAgreementHead soAgreementHead, BindingResult bindingResult) {
    // 参数校验
