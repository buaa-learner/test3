 ...
 * registered service are released. The allowed attributes are cross checked against the list of
 * principal attributes and those that are a match will be released.
 *
 * <p>If the registered service is set to ignore the attribute release policy, the filter will
 * release all principal attributes.
 *
