...
public class InvStockCheckLineServiceImpl implements InvStockCheckLineService {
  ...
  // 注入Dao
  @Autowired private InvStockCheckLineDao invStockCheckLineDao;
  ...
  @Override
  public List<InvStockCheckLine> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, InvStockCheckLineCO paramObj) {
