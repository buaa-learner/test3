...
/**
 * Simple parameterized message descriptor with a code that refers to a message bundle key and a
 * default message string to use if no message code can be resolved.
 *
