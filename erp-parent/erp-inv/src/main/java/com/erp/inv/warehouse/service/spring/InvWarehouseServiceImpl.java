...
public class InvWarehouseServiceImpl implements InvWarehouseService {
  ...
  // 注入Dao
  @Autowired private InvWarehouseDao invWarehouseDao;
  ...
  @Override
  public List<InvWarehouse> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, InvWarehouseCO paramObj) {
