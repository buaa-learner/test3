...
public class PoHeadWebController extends ControllerSupport {
  ...
  public String editPoHead(
      @Valid PoHead poHead, BindingResult bindingResult, Model model, RedirectAttributes attr) {
    // 参数校验
  ...
  public String deletePoHead(PoHead poHead, RedirectAttributes attr) {
    // 删除数据前验证数据
    if (poHead != null
        && poHead.getPoHeadId() != null
        && StringUtils.isNotBlank(poHead.getPoHeadCode())) {
