...
public class FinVoucherModelLineDaoImpl implements FinVoucherModelLineDao {
  ...
  public List<Map<String, Object>> getDataObjectsArray(
      Pages pages, FinVoucherModelLineCO paramObj) {
    return null;
  }

  @Override
  @Permissions(PermissionType.OWN)
  public List<FinVoucherModelLine> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, FinVoucherModelLineCO paramObj) {
    return null;
  }

  @Override
  public List<FinVoucherModelLine> getFinVoucherModelLineListByVoucherHeadCode(
      String voucherHeadCode) {
    String sql =
        "select l.* from fin_voucher_model_line l where voucher_head_code = :voucherheadcode order"
            + " by l.voucher_line_id";
