...
public class HrStaffDepartmentRDaoImpl implements HrStaffDepartmentRDao {
  ...
  public List<HrStaffDepartmentR> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, HrStaffDepartmentRCO paramObj) {
    return null;
  }
  ...
  public List getHrStaffDepartmentRList(Pages pages, HrStaffDepartmentRCO paramObj) {
    String sql =
        "select r.*,s.*,p.*,d.* from hr_staff_department_r r,hr_staff s,hr_position p,hr_department"
            + " d where r.staff_code = s.staff_code and r.position_code = p.position_code and"
