...
/**
 * Merger that retains values from both maps. If a value exists for a key in both maps the following
 * is done:
 *
 * <ul>
 *   <li>If both maps have a {@link List} they are merged into a single {@link List}
 *   <li>If one map has a {@link List} and the other a single value the value is added to the {@link
 *       List}
 *   <li>If both maps have a single value a {@link List} is created from the two.
 * </ul>
 *
