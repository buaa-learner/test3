...
public class MdVendorContactApiController extends ControllerSupport {
  ...
  public String getMdVendorContactList(Pages pages, MdVendorContactCO mdVendorContactCO) {
    ...
    // 分页查询数据
    List<MdVendorContact> list =
        this.mdVendorContactService.getDataObjects(pages, mdVendorContactCO);
  ...
  public String editMdVendorContact(
      @Valid MdVendorContact mdVendorContact, BindingResult bindingResult) {
    // 参数校验
