...
public class FinVoucherHeadServiceImpl implements FinVoucherHeadService {
  ...
  // 注入Dao
  @Autowired private FinVoucherHeadDao finVoucherHeadDao;
  @Autowired private FinVoucherLineDao finVoucherLineDao;
  ...
  public List<FinVoucherHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, FinVoucherHeadCO paramObj) {
    return this.finVoucherHeadDao.getDataObjectsForDataAuth(dataAuthSQL, pages, paramObj);
  }

  @Override
  public void insertOrUpdateFinVoucher(
      FinVoucherHead finVoucherHead, List<FinVoucherLine> finVoucherLineList) {
    // 编辑头
  ...
  @Override
  public void updateFinVoucherHeadForStatus(
      Integer voucherHeadId, String voucherHeadCode, String approveStatus) {
