...
public class MasterDataCommonServiceImpl implements MasterDataCommonService {
  ...
  // 注入Dao
  @Autowired private MdCustomerDao mdCustomerDao;
  @Autowired private MdVendorDao mdVendorDao;
  @Autowired private MdMaterialDao mdMaterialDao;
  @Autowired private MdProjectDao mdProjectDao;
  @Autowired private MdFinanceSubjectDao mdFinanceSubjectDao;
  @Autowired private MdCustomerContactDao mdCustomerContactDao;
  @Autowired private MdVendorContactDao mdVendorContactDao;
  @Autowired private MdCustomerLicenseDao mdCustomerLicenseDao;
  @Autowired private MdVendorLicenseDao mdVendorLicenseDao;

  @Override
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.CUSTOMER_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.CUSTOMER_OWN_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.MATERIAL_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.MATERIAL_MATERIAL_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.MATERIAL_MATTER_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.PROJECT_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.VENDOR_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.VENDOR_OWN_CACHE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = MasterDataParam.SUBJECT_CACHE_KEY)
  ...
  public MdCustomer getMdCustomerInfoCache(String customerCode) {
    ...
    List<MdCustomerContact> mdCustomerContactList =
        this.mdCustomerContactDao.getDataObjects(mdCustomerContactCO);
    // 设置联系人
    ...
    List<MdCustomerLicense> mdCustomerLicenseList =
        this.mdCustomerLicenseDao.getDataObjects(mdCustomerLicenseCO);
    // 设置营业执照
  ...
  public MdVendor getMdVendorInfoCache(String vendorCode) {
    ...
    List<MdVendorContact> mdVendorContactList =
        this.mdVendorContactDao.getDataObjects(mdVendorContactCO);
    // 设置联系人
    ...
    List<MdVendorLicense> mdVendorLicenseList =
        this.mdVendorLicenseDao.getDataObjects(mdVendorLicenseCO);
    // 设置营业执照
