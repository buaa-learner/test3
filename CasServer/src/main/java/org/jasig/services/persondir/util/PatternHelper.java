...
public class PatternHelper {
  /**
   * Converts a String using the {@link IPersonAttributeDao#WILDCARD} into a valid regular
   * expression {@link Pattern} with the {@link IPersonAttributeDao#WILDCARD} replaced by .* and the
   * rest of the string escaped using {@link Pattern#quote(String)}
   */
