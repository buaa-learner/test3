...
public class SoAgreementHeadServiceImpl implements SoAgreementHeadService {
  ...
  // 注入Dao
  @Autowired private SoAgreementHeadDao soAgreementHeadDao;
  @Autowired private SoAgreementLineService soAgreementLineService;
  @Autowired private SoAgreementLineDao soAgreementLineDao;
  ...
  @Override
  public List<SoAgreementHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, SoAgreementHeadCO paramObj) {
