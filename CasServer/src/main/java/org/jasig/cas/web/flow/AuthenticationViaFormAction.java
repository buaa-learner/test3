...
/**
 * Action to authenticate credential and retrieve a TicketGrantingTicket for those credential. If
...
public class AuthenticationViaFormAction {
  ...
  @NotNull private CookieGenerator warnCookieGenerator;
  ...
  /**
   * Set a CredentialsBinder for additional binding of the HttpServletRequest to the Credential
   * instance, beyond our default binding of the Credential as a Form Object in Spring WebMVC
   ...
   * the Credential implementation of the same name, we have set that property to be the value of
   * the corresponding request parameter. This CredentialsBinder plugin point exists to allow
   * consideration of things other than HttpServletRequest parameters in populating the Credential
   * (or more sophisticated consideration of the HttpServletRequest parameters).
   *
