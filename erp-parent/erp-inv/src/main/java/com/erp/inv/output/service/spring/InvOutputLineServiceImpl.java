...
public class InvOutputLineServiceImpl implements InvOutputLineService {
  ...
  // 注入Dao
  @Autowired private InvOutputLineDao invOutputLineDao;
  ...
  public void deleteDataObject(InvOutputLine obj) {
    ...
    this.invStockService.deleteInvStockByBillLineCode(
        "OUTPUT", temp.getOutputHeadCode(), temp.getOutputLineCode());
  ...
  @Override
  public List<InvOutputLine> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, InvOutputLineCO paramObj) {
    return this.invOutputLineDao.getDataObjectsForDataAuth(dataAuthSQL, pages, paramObj);
  }

  @Override
  public List<InvOutputLine> getInvOutputLineListByOutputHeadCode(
      Pages pages, InvOutputLineCO paramObj) {
