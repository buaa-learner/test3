...
public class ArInvoiceHeadServiceImpl implements ArInvoiceHeadService {
  ...
  // 注入Dao
  @Autowired private ArInvoiceHeadDao receiptHeadDao;
  @Autowired private ArInvoiceLineService receiptLineService;
  ...
  @Override
  public List<ArInvoiceHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, ArInvoiceHeadCO paramObj) {
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    ...
    if (approveStatus.equals("APPROVE")) {
      ...
      String voucherHeadCode =
          this.finVoucherBillRService.getVoucherHeadCodeByBillHeadCode("AR_INVOICE", code);
      // 删除凭证
