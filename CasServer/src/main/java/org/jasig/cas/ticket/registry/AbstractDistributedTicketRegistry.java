...
/**
 * Abstract Implementation that handles some of the commonalities between distributed ticket
 * registries.
 *
...
public abstract class AbstractDistributedTicketRegistry extends AbstractTicketRegistry {
  ...
  protected final Ticket getProxiedTicketInstance(final Ticket ticket) {
    ...
    if (ticket instanceof TicketGrantingTicket) {
      return new TicketGrantingTicketDelegator(
          this, (TicketGrantingTicket) ticket, needsCallback());
    }
  ...
  private static final class ServiceTicketDelegator extends TicketDelegator<ServiceTicket>
    ...
    public TicketGrantingTicket grantTicketGrantingTicket(
      ...
      final TicketGrantingTicket t =
          this.getTicket().grantTicketGrantingTicket(id, authentication, expirationPolicy);
      updateTicket();
      return t;
    }
  }

  private static final class TicketGrantingTicketDelegator
      extends TicketDelegator<TicketGrantingTicket> implements TicketGrantingTicket {
    ...
    public ServiceTicket grantServiceTicket(
      ...
      final ServiceTicket t =
          this.getTicket().grantServiceTicket(id, service, expirationPolicy, credentialsProvided);
      updateTicket();
      return t;
    }
