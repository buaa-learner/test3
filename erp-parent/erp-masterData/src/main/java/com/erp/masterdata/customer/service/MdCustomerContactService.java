...
public interface MdCustomerContactService
    extends DaoCRUDIF<MdCustomerContact, MdCustomerContactCO> {

  // 查询客户的联系人数量
  public abstract int getContactCountByCustomerCode(String customerCode);

  // 查询客户的联系人列表(分页)
  public abstract List<MdCustomerContact> getContactListByCustomerCode(
