...
/**
 * Default implementation of {@link UniqueTicketIdGenerator}. Implementation utilizes a
 * DefaultLongNumericGeneraor and a DefaultRandomStringGenerator to construct the ticket id.
 *
 * <p>Tickets are of the form [PREFIX]-[SEQUENCE NUMBER]-[RANDOM STRING]-[SUFFIX]
 *
...
public final class DefaultUniqueTicketIdGenerator implements UniqueTicketIdGenerator {
  ...
  /**
   * Creates an instance of DefaultUniqueTicketIdGenerator with default values including a {@link
   * DefaultLongNumericGenerator} with a starting value of 1.
   */
  ...
  /**
   * Creates an instance of DefaultUniqueTicketIdGenerator with a specified maximum length for the
   * random portion.
   *
   * @param maxLength the maximum length of the random string used to generate the id.
   */
   ...
   * DefaultLongNumericGenerator} with a starting value of 1.
   *
   * @param suffix the value to append at the end of the unique id to ensure uniqueness across JVMs.
   */
