...
public class InvInputHeadServiceImpl implements InvInputHeadService {
  ...
  // 注入Dao
  @Autowired private InvInputHeadDao invInputHeadDao;
  ...
  @Override
  public List<InvInputHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, InvInputHeadCO paramObj) {
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    ...
    if (approveStatus.equals("APPROVE")) {
      ...
      List<InvInputLine> inputLineList =
          this.invInputLineService.getInvInputLineListByInputHeadCode(code);
      ...
      this.finVoucherModelHeadService.autoCreateVoucher(
          code, new Double[] {voucherAmount.doubleValue()}, "INPUT");
      ...
      String voucherHeadCode =
          this.finVoucherBillRService.getVoucherHeadCodeByBillHeadCode("INPUT", code);
      // 删除凭证
