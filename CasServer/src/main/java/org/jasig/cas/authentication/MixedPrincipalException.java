...
/**
 * Describes an error condition where non-identical principals have been resolved while
 * authenticating multiple credentials.
 *
...
public class MixedPrincipalException extends PrincipalException {
  ...
  /**
   * Creates a new instance from what would otherwise have been a successful authentication event
   * and the two disparate principals resolved.
   *
  ...
  public MixedPrincipalException(
      final Authentication authentication, final Principal a, final Principal b) {
