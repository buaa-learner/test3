 ...
 * Cas10ProtocolValidationSpecification, checking for the presence of renew=true and if requested,
 * succeeding only if ticket validation is occurring from a new login.
 *
