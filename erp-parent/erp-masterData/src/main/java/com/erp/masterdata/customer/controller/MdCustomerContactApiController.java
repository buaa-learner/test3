...
public class MdCustomerContactApiController extends ControllerSupport {
  ...
  public String getMdCustomerContactList(Pages pages, MdCustomerContactCO mdCustomerContactCO) {
    ...
    // 分页查询数据
    List<MdCustomerContact> list =
        this.mdCustomerContactService.getDataObjects(pages, mdCustomerContactCO);
  ...
  public String editMdCustomerContact(
      @Valid MdCustomerContact mdCustomerContact, BindingResult bindingResult) {
    // 参数校验
