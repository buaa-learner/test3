...
/**
 * Maps calls to {@link org.jasig.services.persondir.IPersonAttributeDao#getPeople(Map)} to {@link
...
public abstract class AbstractFlatteningPersonAttributeDao extends BasePersonAttributeDao {
  ...
  public final Set<IPersonAttributes> getPeople(Map<String, Object> query) {
    final Map<String, List<Object>> multivaluedSeed =
        MultivaluedPersonAttributeUtils.toMultivaluedMap(query);
    return this.getPeopleWithMultivaluedAttributes(multivaluedSeed);
  }

  /**
   * @deprecated Use {@link MultivaluedPersonAttributeUtils#toMultivaluedMap(Map)} instead. This
