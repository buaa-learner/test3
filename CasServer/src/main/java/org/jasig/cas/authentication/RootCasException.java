...
/**
 * Generic CAS exception that sits at the top of the exception hierarchy. Provides unified logic
 * around retrieval and configuration of exception codes that may be mapped inside an external
 * resource bundle for internationalization of error messages.
 *
...
public abstract class RootCasException extends Exception {
  ...
  /**
   * @return Returns the code. If there is a chained exception it recursively calls {@link
   *     #getCode()} of the chained exception rather than the returning the code itself.
   */
