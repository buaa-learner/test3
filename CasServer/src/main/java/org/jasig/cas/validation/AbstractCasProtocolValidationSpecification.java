...
/**
 * Base validation specification for the CAS protocol. This specification checks for the presence of
 * renew=true and if requested, succeeds only if ticket validation is occurring from a new login.
 *
