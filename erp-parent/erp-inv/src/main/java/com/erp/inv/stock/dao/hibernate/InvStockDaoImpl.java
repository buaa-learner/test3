...
public class InvStockDaoImpl implements InvStockDao {
  ...
  public List<InvStock> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, InvStockCO paramObj) {
    return null;
  }
  ...
  public boolean isExistRelateDataForInvStock(String warehouseCode, String materialCode) {
    String sql =
        "select count(*) from inv_stock where warehouse_code = :warehouseCode and material_code ="
            + " :materialCode";
  ...
  public void deleteInvStockByBillHeadCode(String billType, String billHeadCode) {
    String sql =
        "delete from inv_stock where bill_type = :billType and bill_head_code = :billHeadCode";
  ...
  @Override
  public void deleteInvStockByBillLineCode(
      String billType, String billHeadCode, String billLineCode) {
    String sql =
        "delete from inv_stock where bill_type = :billType and bill_head_code = :billHeadCode and"
            + " bill_line_code = :billLineCode";
