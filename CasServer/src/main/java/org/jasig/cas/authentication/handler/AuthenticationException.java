...
/**
 * The most generic type of authentication exception that one can catch if not sure what specific
 * implementation will be thrown. Top of the tree of all other AuthenticationExceptions.
 *
