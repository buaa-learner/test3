...
/**
 * Provides the username attribute based on a pre-configured string. Determines the username from a
 * query Map based on the configured attribute, {@link StringUtils#trimToNull(String)}, and if the
 * username value does not contain a wildcard.
 *
