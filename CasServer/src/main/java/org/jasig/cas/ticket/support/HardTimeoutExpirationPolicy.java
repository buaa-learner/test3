...
/**
 * Ticket expiration policy based on a hard timeout from ticket creation time rather than the "idle"
 * timeout provided by {@link org.jasig.cas.ticket.support.TimeoutExpirationPolicy}.
 *
...
public final class HardTimeoutExpirationPolicy implements ExpirationPolicy, Serializable {
  ...
  public boolean isExpired(final TicketState ticketState) {
    return (ticketState == null)
        || (System.currentTimeMillis() - ticketState.getCreationTime()
