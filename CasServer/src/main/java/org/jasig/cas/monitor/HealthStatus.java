...
public class HealthStatus extends Status {
   ...
   * @param detailMap Map of names to status information. A reasonable name would be, for example,
   *     the name of the monitor that produced it.
   * @see #getCode()
   */
  ...
  /**
   * Gets the status details comprising the individual health checks performed for overall health
   * status.
   *
