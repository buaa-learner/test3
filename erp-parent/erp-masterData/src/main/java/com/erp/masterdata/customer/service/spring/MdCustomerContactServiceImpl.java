...
public class MdCustomerContactServiceImpl implements MdCustomerContactService {
  ...
  @Override
  public List<MdCustomerContact> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, MdCustomerContactCO paramObj) {
  ...
  @Override
  public List<MdCustomerContact> getContactListByCustomerCode(
      Pages pages, MdCustomerContactCO paramObj) {
