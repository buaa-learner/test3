...
public class SysDatasetDaoImpl implements SysDatasetDao {
  ...
  public List<SysDataset> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, SysDatasetCO paramObj) {
    return null;
  }
  ...
  public Map<String, String> getDatasetMap(String datasetTypeCode) {
    String sql =
        "select d.* from sys_dataset d where d.dataset_type_code = :datasetTypeCode and d.status ="
            + " 'Y' order by d.dataset_code";
