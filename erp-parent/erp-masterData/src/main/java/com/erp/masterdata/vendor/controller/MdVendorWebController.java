...
public class MdVendorWebController extends ControllerSupport {
  ...
  @Autowired private MdVendorContactService mdVendorContactService;
  @Autowired private MdVendorLicenseService mdVendorLicenseService;
  ...
  public String editMdVendor(
      @Valid MdVendor mdVendor, BindingResult bindingResult, Model model, RedirectAttributes attr) {
    // 参数校验
  ...
  public String deleteMdVendor(MdVendor mdVendor, RedirectAttributes attr) {
    // 删除数据前验证数据
    if (mdVendor != null
        && mdVendor.getVendorId() != null
        && StringUtils.isNotBlank(mdVendor.getVendorCode())) {
      int bankCount = this.mdVendorBankService.getBankCountByVendorCode(mdVendor.getVendorCode());
      int contactCount =
          this.mdVendorContactService.getContactCountByVendorCode(mdVendor.getVendorCode());
      int licenseCount =
          this.mdVendorLicenseService.getLicenseCountByVendorCode(mdVendor.getVendorCode());
