...
public final class DefaultTicketRegistry extends AbstractTicketRegistry {
  ...
  /**
   * Creates a new, empty registry with the specified initial capacity, load factor, and concurrency
   * level.
   *
  ...
  public DefaultTicketRegistry(
    ...
    this.cache =
        new ConcurrentHashMap<String, Ticket>(initialCapacity, loadFactor, concurrencyLevel);
  }
