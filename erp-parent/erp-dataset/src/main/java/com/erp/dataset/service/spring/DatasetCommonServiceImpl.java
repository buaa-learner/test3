...
public class DatasetCommonServiceImpl implements DatasetCommonService {
  ...
  // 注入Dao
  @Autowired private SysDatasetDao sysDatasetDao;
  ...
  // cacheKey=DatasetParam.MATERIAL_CATEGORY_KEY)
  //    @Deprecated
  ...
  @Cache(
      ...
      cacheSeconds = 7200,
      cacheKey = DatasetParam.PROD_RESOURCE_CHARGE_TYPE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = DatasetParam.PROD_RESOURCE_COUNT_TYPE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = DatasetParam.PROD_RESOURCE_TYPE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = DatasetParam.PROD_WORK_CENTER_TYPE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = DatasetParam.PROD_WORK_SCHEDULE_KEY)
  ...
  @Cache(
      cacheType = CacheType.ALL,
      cacheSeconds = 7200,
      cacheKey = DatasetParam.EXPENSE_ITEM_TYPE_KEY)
