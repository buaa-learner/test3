...
public class ArReceiptHeadServiceImpl implements ArReceiptHeadService {
  ...
  // 注入Dao
  @Autowired private ArReceiptHeadDao arReceiptHeadDao;
  ...
  @Override
  public List<ArReceiptHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, ArReceiptHeadCO paramObj) {
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    ...
    if (approveStatus.equals("APPROVE")) {
      ...
      this.finVoucherModelHeadService.autoCreateVoucher(
          code, new Double[] {voucherAmount.doubleValue()}, "RECEIPT");
    } else if (approveStatus.equals("UNSUBMIT")) {
      // ===========================删除自动生成的凭证和分录
      // 根据单据头code获取凭证头code
      String voucherHeadCode =
          this.finVoucherBillRService.getVoucherHeadCodeByBillHeadCode("RECEIPT", code);
      // 删除凭证
  ...
  @Override
  public List<ArReceiptHead> getArReceiptHeadListForNotCreateVoucher(
      Pages pages, ArReceiptHeadCO paramObj) {
