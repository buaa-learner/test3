...
public class ArReceiptLine implements java.io.Serializable {
  ...
  // 用于显示的字段
  @Transient private Double invoiceAmount;
  @Transient private Double invoiceReceivedAmount;
  @Transient private Double taxAmount;
  @Transient private String soHeadCode;
  @Transient private String referenceNumber;
  @Transient private Date invoiceDate;
