...
public interface Assertion {
   ...
   *
   * @return Non-null, non-empty list of authentications in leaf-first order (i.e. authentications
   *     on the root ticket occur at the end).
   */
  List<Authentication> getChainedAuthentications();

  /**
   * True if the validated ticket was granted in the same transaction as that in which its grantor
   * GrantingTicket was originally issued.
   *
