...
public class FinVoucherModelLineWebController extends ControllerSupport {
  ...
  public String getFinVoucherModelLineList(
      Pages pages, FinVoucherModelLineCO finVoucherModelLineCO, Model model) {
    // TODO: 分页查询数据
    if (pages.getPage() == 0) {
      pages.setPage(1);
    }
    ...
    List<FinVoucherModelLine> finVoucherModelLineList =
        this.finVoucherModelLineService.getDataObjects(pages, finVoucherModelLineCO);
  ...
  public String editFinVoucherModelLine(
      @Valid FinVoucherModelLine finVoucherModelLine,
  ...
  public String deleteFinVoucherModelLine(
      FinVoucherModelLine finVoucherModelLine, String voucherHeadId, RedirectAttributes attr) {
    // 删除数据前验证数据
