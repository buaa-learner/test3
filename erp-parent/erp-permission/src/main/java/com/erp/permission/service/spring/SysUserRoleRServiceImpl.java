...
public class SysUserRoleRServiceImpl implements SysUserRoleRService {
  ...
  // 注入Dao
  @Autowired private SysUserRoleRDao sysUserRoleRDao;
  ...
  @Override
  public List<SysUserRoleR> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, SysUserRoleRCO paramObj) {
