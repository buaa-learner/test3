...
public class ArReceiptLineDaoImpl implements ArReceiptLineDao {
  ...
  public List<ArReceiptLine> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, ArReceiptLineCO paramObj) {
    return null;
  }
  ...
  public Double getInvoiceReceiveAmount(String invoiceHeadCode, Integer receiptLineId) {
    String sql =
        "select sum(l.invoice_receipt_amount) from ar_receipt_line l where l.invoice_head_code ="
            + " :code and l.receipt_line_id <> :id";
