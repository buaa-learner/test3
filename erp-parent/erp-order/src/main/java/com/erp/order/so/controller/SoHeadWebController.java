...
public class SoHeadWebController extends ControllerSupport {
  ...
  public String editSoHead(
      @Valid SoHead soHead, BindingResult bindingResult, Model model, RedirectAttributes attr) {
    // 参数校验
  ...
  public String deleteSoHead(SoHead soHead, RedirectAttributes attr) {
    // 删除数据前验证数据
    if (soHead != null
        && soHead.getSoHeadId() != null
        && StringUtils.isNotBlank(soHead.getSoHeadCode())) {
