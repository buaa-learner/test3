...
public class MdVendorBankServiceImpl implements MdVendorBankService {
  ...
  // 注入Dao
  @Autowired private MdVendorBankDao mdVendorBankDao;
  ...
  @Override
  public List<MdVendorBank> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, MdVendorBankCO paramObj) {
