...
public class InvOutputHeadServiceImpl implements InvOutputHeadService {
  ...
  // 注入Dao
  @Autowired private InvOutputHeadDao invOutputHeadDao;
  ...
  @Override
  public List<InvOutputHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, InvOutputHeadCO paramObj) {
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    ...
    if (approveStatus.equals("APPROVE")) {
      ...
      List<InvOutputLine> outputLineList =
          this.invOutputLineService.getInvOutputLineListByOutputHeadCode(code);
      ...
      this.finVoucherModelHeadService.autoCreateVoucher(
          code, new Double[] {voucherAmount.doubleValue()}, "OUTPUT");
      ...
      String voucherHeadCode =
          this.finVoucherBillRService.getVoucherHeadCodeByBillHeadCode("OUTPUT", code);
      // 删除凭证
