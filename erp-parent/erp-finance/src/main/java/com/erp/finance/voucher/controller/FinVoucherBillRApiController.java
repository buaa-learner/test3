...
public class FinVoucherBillRApiController extends ControllerSupport {
  ...
  public String getFinVoucherBillRList(Pages pages, FinVoucherBillRCO finVoucherBillRCO) {
    ...
    // 分页查询数据
    List<FinVoucherBillR> list =
        this.finVoucherBillRService.getDataObjects(pages, finVoucherBillRCO);
  ...
  public String editFinVoucherBillR(
      @Valid FinVoucherBillR finVoucherBillR, BindingResult bindingResult) {
    // 参数校验
