...
public class HrStaffDaoImpl implements HrStaffDao {
  ...
  public List<HrStaff> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, HrStaffCO paramObj) {
    return null;
  }
  ...
  public HrStaffInfoRO getHrStaffInfoRO(String username) {
    String sql =
        "select s.staff_code as staffCode,s.staff_name as staffName,d.department_code as"
            + " departmentCode,d.department_name as departmentName,d.segment_code as"
            + " deaprtmentSegmentCode,d.segment_desc as departmentSegmentDesc,p.position_code as"
            + " positionCode,p.position_name as positionName from hr_staff s,hr_staff_department_r"
            + " r,hr_department d,hr_position p where s.staff_code=r.staff_code and"
            + " r.department_code=d.department_code and r.position_code=p.position_code and"
            + " r.status = 'Y' and s.username=:username and s.staff_status='WORK'";
