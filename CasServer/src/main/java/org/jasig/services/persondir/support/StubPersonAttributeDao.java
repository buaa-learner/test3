...
/**
 * A stub IPersonAttributeDao to be used for testing. Backed by a single Map which this
 * implementation will always return. <br>
 * <br>
 * Configuration:
 *
 * <table border="1">
  ...
  public IPersonAttributes getPerson(String uid) {
    if (uid == null) {
      throw new IllegalArgumentException(
          "Illegal to invoke getPerson(String) with a null argument.");
    }
