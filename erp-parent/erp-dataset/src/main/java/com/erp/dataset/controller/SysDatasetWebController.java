...
public class SysDatasetWebController extends ControllerSupport {
  ...
  // 服务层注入
  @Autowired private SysDatasetService sysDatasetService;
  ...
  public String editSysDataset(
      @Valid SysDataset sysDataset,
  ...
  public String deleteSysDataset(
      SysDataset sysDataset, String datasetTypeName, RedirectAttributes attr) {
    // 删除数据前验证数据
    if (sysDataset != null && sysDataset.getDatasetId() != null) {
      // 删除数据
