...
public class DateJacksonConverterConf extends JsonDeserializer<Date> {
      ...
      try {
        ...
        try {
          ...
          throw new IOException(
              String.format(
                  "'%s' can not convert to type 'java.util.Date',just support timestamp(type of"
                      + " long) and following date format(%s)",
  ...
  public Jackson2ObjectMapperFactoryBean jackson2ObjectMapperFactoryBean(
      @Autowired DateJacksonConverterConf dateJacksonConverter) {
