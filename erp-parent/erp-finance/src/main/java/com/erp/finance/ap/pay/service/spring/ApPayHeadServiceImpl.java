...
public class ApPayHeadServiceImpl implements ApPayHeadService {
  ...
  // 注入Dao
  @Autowired private ApPayHeadDao apPayHeadDao;
  ...
  @Override
  public List<ApPayHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, ApPayHeadCO paramObj) {
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    ...
    if (approveStatus.equals("APPROVE")) {
      ...
      this.finVoucherModelHeadService.autoCreateVoucher(
          code, new Double[] {voucherAmount.doubleValue()}, "PAY");
    } else if (approveStatus.equals("UNSUBMIT")) {
      // ===========================删除自动生成的凭证和分录
      // 根据单据头code获取凭证头code
      String voucherHeadCode =
          this.finVoucherBillRService.getVoucherHeadCodeByBillHeadCode("PAY", code);
      // 删除凭证
