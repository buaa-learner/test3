...
public class PoAgreementHeadServiceImpl implements PoAgreementHeadService {
  ...
  // 注入Dao
  @Autowired private PoAgreementHeadDao poAgreementHeadDao;
  @Autowired private PoAgreementLineService poAgreementLineService;
  @Autowired private PoAgreementLineDao poAgreementLineDao;
  ...
  @Override
  public List<PoAgreementHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, PoAgreementHeadCO paramObj) {
