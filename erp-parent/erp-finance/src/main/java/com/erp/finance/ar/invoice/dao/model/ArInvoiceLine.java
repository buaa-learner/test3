...
public class ArInvoiceLine implements java.io.Serializable {
   ...
   * 用于显示的字段
   */
  @Transient private String materialCode;
  @Transient private String materialName;
  @Transient private String standard;
  @Transient private Double price;
  @Transient private Double outputQuantity;
  @Transient private Double madeInvoiceQuantity;
  @Transient private String unit;
  @Transient private Double soLineAmount;
