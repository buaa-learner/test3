...
/**
 * Provides a custom {@link javax.validation.TraversableResolver} that should work in JPA2
 * environments without the JPA2 restrictions (i.e. getters for all properties).
 *
