...
/**
 * A builder that uses the saml standard's <code>LogoutRequest</code> template in order to build the
 * logout request.
 *
...
public final class SamlCompliantLogoutMessageCreator implements LogoutMessageCreator {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SamlCompliantLogoutMessageCreator.class);
  ...
  private static final String LOGOUT_REQUEST_TEMPLATE =
      "<samlp:LogoutRequest xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\" ID=\"%s\""
          + " Version=\"2.0\" IssueInstant=\"%s\"><saml:NameID"
