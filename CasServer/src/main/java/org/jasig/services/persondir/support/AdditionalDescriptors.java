...
/**
 * Implementation of {@link IPersonAttributes} for use with {@link
 * AdditionalDescriptorsPersonAttributeDao}. Unlike most other implementations, <code>
 * AdditionalDescriptors</code> is mutable. An instance of this class typically lives for the
 * duration of a session or application, and external components are expected to add attributes to
 * the collection after creation.
 *
 * @author awills
 */
