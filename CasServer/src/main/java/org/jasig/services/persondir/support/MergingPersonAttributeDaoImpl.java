...
/**
 * A {@link IPersonAttributeDao} implementation which iterates over children IPersonAttributeDaos
 * queries each with the same data and merges their reported attributes in a configurable way. The
 * default merger is {@link MultivaluedAttributeMerger}.
 *
