...
public class MdCustomerLicenseApiController extends ControllerSupport {
  ...
  public String getMdCustomerLicenseList(Pages pages, MdCustomerLicenseCO mdCustomerLicenseCO) {
    ...
    // 分页查询数据
    List<MdCustomerLicense> list =
        this.mdCustomerLicenseService.getDataObjects(pages, mdCustomerLicenseCO);
  ...
  public String editMdCustomerLicense(
      @Valid MdCustomerLicense mdCustomerLicense, BindingResult bindingResult) {
    // 参数校验
