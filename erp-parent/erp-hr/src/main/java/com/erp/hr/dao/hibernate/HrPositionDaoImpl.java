...
public class HrPositionDaoImpl implements HrPositionDao {
  ...
  public List<HrPosition> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, HrPositionCO paramObj) {
    return null;
  }
  ...
  public boolean isExistRelateDataForHrPosition(String positionCode) {
    String sql =
        "select count(*) from hr_staff_department_r sd where sd.position_code = :positionCode";
