...
public class HrStaffDepartmentRApiController extends ControllerSupport {
  ...
  public String getHrStaffDepartmentRList(Pages pages, HrStaffDepartmentRCO hrStaffDepartmentRCO) {
    ...
    // 分页查询数据
    List<HrStaffDepartmentR> list =
        this.hrStaffDepartmentRService.getDataObjects(pages, hrStaffDepartmentRCO);
  ...
  public String editHrStaffDepartmentR(
      @Valid HrStaffDepartmentR hrStaffDepartmentR, BindingResult bindingResult) {
    // 参数校验
