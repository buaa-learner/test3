...
public class ApInvoiceHeadServiceImpl implements ApInvoiceHeadService {
  ...
  // 注入Dao
  @Autowired private ApInvoiceHeadDao payHeadDao;
  @Autowired private ApInvoiceLineService payLineService;
  ...
  @Override
  public List<ApInvoiceHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, ApInvoiceHeadCO paramObj) {
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    ...
    if (approveStatus.equals("APPROVE")) {
      ...
      String voucherHeadCode =
          this.finVoucherBillRService.getVoucherHeadCodeByBillHeadCode("AP_INVOICE", code);
      // 删除凭证
