...
public class MdCustomerContactWebController extends ControllerSupport {
  ...
  public String getMdCustomerContactList(
      Pages pages, MdCustomerContactCO mdCustomerContactCO, Model model) {
    // 分页查询数据
    if (pages.getPage() == 0) {
      pages.setPage(1);
    }
    ...
    List<MdCustomerContact> mdCustomerContactList =
        this.mdCustomerContactService.getContactListByCustomerCode(pages, mdCustomerContactCO);
  ...
  public String getMdCustomerContact(MdCustomerContact mdCustomerContact, Model model) {
    ...
    if (mdCustomerContact != null && mdCustomerContact.getContactId() != null) {
      mdCustomerContact =
          this.mdCustomerContactService.getDataObject(mdCustomerContact.getContactId());
    }
  ...
  @ResponseBody
  public String editMdCustomerContact(
      @Valid @RequestBody MdCustomerContact mdCustomerContact,
  ...
  @ResponseBody
  public String deleteMdCustomerContact(
      @RequestBody MdCustomerContact mdCustomerContact, RedirectAttributes attr) {
    try {
      // 删除数据前验证数据
      if (mdCustomerContact != null && mdCustomerContact.getContactId() != null) {
        // 删除数据
