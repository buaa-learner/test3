...
public class ArReceiptHeadDaoImpl implements ArReceiptHeadDao {
  ...
  public List<ArReceiptHead> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, ArReceiptHeadCO paramObj) {
    return null;
  }
  ...
  public List<ArReceiptHead> getArReceiptHeadListForNotCreateVoucher(
    ...
    sql =
        sql
            + " and not exists (select 1 from fin_voucher_bill_r where bill_type = 'RECEIPT' and"
            + " bill_head_code = p.receipt_head_code)";
