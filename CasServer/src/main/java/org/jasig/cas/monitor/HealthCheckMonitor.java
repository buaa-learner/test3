...
/**
 * Simple health check monitor that reports the overall health as the greatest reported {@link
...
public class HealthCheckMonitor implements Monitor<HealthStatus> {
  ...
  @NotNull private Collection<Monitor> monitors = Collections.emptySet();
