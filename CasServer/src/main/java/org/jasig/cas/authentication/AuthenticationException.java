 ...
 * fail to authenticate credentials. This exception contains information about handler successes and
 * failures that may be used by higher-level components to determine subsequent behavior.
 *
...
public class AuthenticationException extends Exception {
  ...
  /**
   * Creates a new instance for the case when no handlers were attempted, i.e. no successes or
   * failures.
   */
  ...
  /**
   * Creates a new instance for the case when there are both handler successes and failures and a
