...
/**
 * Error condition arising at ticket creation or validation time when a ticketing operation relying
 * on authentication cannot proceed due to unsatisfied authentication security policy.
 *
