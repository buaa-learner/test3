...
public class AuthenticationBuilder {
  ...
  /**
   * Adds an authentication success to the map of handler names to successful authentication handler
   * results.
   *
  ...
  /**
   * Adds an authentication failure to the map of handler names to the authentication handler
   * failures.
   *
   * @param key Authentication handler name.
   ...
   * @return This builder instance.
   */
  public AuthenticationBuilder addFailure(
      final String key, final Class<? extends Exception> value) {
