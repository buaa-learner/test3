...
public class PoAgreementHeadApiController extends ControllerSupport {
  ...
  public String getPoAgreementHeadList(Pages pages, PoAgreementHeadCO poAgreementHeadCO) {
    ...
    // 分页查询数据
    List<PoAgreementHead> list =
        this.poAgreementHeadService.getDataObjects(pages, poAgreementHeadCO);
  ...
  public String editPoAgreementHead(
      @Valid PoAgreementHead poAgreementHead, BindingResult bindingResult) {
    // 参数校验
