...
public abstract class AbstractWebApplicationService implements SingleLogoutService {
  ...
  protected static final Logger LOGGER =
      LoggerFactory.getLogger(AbstractWebApplicationService.class);
  ...
  protected AbstractWebApplicationService(
      final String id, final String originalUrl, final String artifactId) {
    this.id = id;
  ...
  /**
   * Return the original url provided (as <code>service</code> or <code>targetService</code> request
   * parameter). Used to reconstruct the redirect url.
   *
