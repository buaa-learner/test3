...
public class SysUserWebController extends ControllerSupport {
  ...
  @Autowired private SysUserRoleRService sysUserRoleRService;
  ...
  public String editSysUser(
      @Valid SysUser sysUser, BindingResult bindingResult, Model model, RedirectAttributes attr) {
    // 参数校验
  ...
  public String beforeRelateSysUserRole(String username, Model model) {
    ...
    if (StringUtils.isNotBlank(username)) {
      // 获取用户已关联的角色
      List<SysRole> sysRoleRelateList =
          this.sysRoleService.getRelateSysRoleListByUsername(username);
  ...
  public String relateSysUserRole(
      String username, String[] roleCode, Model model, RedirectAttributes attr) {
