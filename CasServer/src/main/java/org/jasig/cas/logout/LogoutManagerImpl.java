...
public final class LogoutManagerImpl implements LogoutManager {
  ...
  @NotNull private final LogoutMessageCreator logoutMessageBuilder;
  ...
  private boolean performBackChannelLogout(final LogoutRequest request) {
    ...
    return this.httpClient.sendMessageToEndPoint(
        request.getService().getOriginalUrl(), logoutRequest, true);
  }
