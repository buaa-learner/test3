...
public class FinVoucherModelHeadDaoImpl implements FinVoucherModelHeadDao {
  ...
  public List<FinVoucherModelHead> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, FinVoucherModelHeadCO paramObj) {
    return null;
  }
  ...
  public List<FinVoucherModelHead> getFinVoucherModelHeadListForCustom() {
    String sql =
        "select h.* from fin_voucher_model_head h where h.status = 'Y' "
  ...
  public FinVoucherModelHead getFinVoucherModelHeadByBusinessType(String businessType) {
    String sql =
        "select h.* from fin_voucher_model_head h where business_type = :businesstype order by"
            + " h.voucher_head_id desc";
