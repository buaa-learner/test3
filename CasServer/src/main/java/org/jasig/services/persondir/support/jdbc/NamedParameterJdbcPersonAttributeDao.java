 ...
 * attributes with the property 'userAttributeNames' (you can adjust names to taste using aliases in
 * your SQL). Supports multi-valued attributes through inner joins.
 *
 * <p>Example SQL: SELECT USER_ID FROM UP_USER WHERE USER_NAME = :username
 *
 * <p>Example Sprring Configuration: &lt;bean id="rolesUserSource"
 * class="org.jasig.services.persondir.support.jdbc.NamedParameterJdbcPersonAttributeDao"&gt;
 * &lt;property name="dataSource" ref="PersonDB" /&gt; &lt;property name="sql"&gt; &lt;value&gt;
 * SELECT rolename AS scsRoleName from s_external_role where oprid = UPPER(:username) &lt;/value&gt;
 * &lt;/property&gt; &lt;property name="usernameAttributeProvider" ref="usernameAttributeProvider"
 * /&gt; &lt;property name="userAttributeNames"&gt; &lt;set&gt;
 * &lt;value&gt;scsRoleName&lt;/value&gt; &lt;/set&gt; &lt;/property&gt; &lt;/bean&gt;
 *
 * @author drew wills
 */
public class NamedParameterJdbcPersonAttributeDao extends AbstractDefaultAttributePersonAttributeDao
