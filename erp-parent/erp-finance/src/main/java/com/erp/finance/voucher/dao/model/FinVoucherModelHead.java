...
public class FinVoucherModelHead implements java.io.Serializable {
  ...
  @Transient private String amountDesc;
  @Transient private String drAmount;
  @Transient private String crAmount;
  @Transient private String[] drAmountArray;
  @Transient private String[] crAmountArray;
  @Transient private List<FinVoucherModelLine> finVoucherModelLineList;
