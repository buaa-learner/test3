...
/**
 * Immutable authentication event whose attributes may not change after creation. This class is
 * designed for serialization and is suitable for long-term storage.
 *
...
public final class ImmutableAuthentication implements Authentication, Serializable {
  ...
  /**
   * Immutable date implementation that throws {@link UnsupportedOperationException} for setter
   * methods.
   */
