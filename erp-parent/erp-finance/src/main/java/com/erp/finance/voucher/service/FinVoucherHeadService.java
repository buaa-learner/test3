...
public interface FinVoucherHeadService extends DaoCRUDIF<FinVoucherHead, FinVoucherHeadCO> {
  ...
  // 同时插入或修改凭证头行
  public abstract void insertOrUpdateFinVoucher(
      FinVoucherHead finVoucherHead, List<FinVoucherLine> finVoucherLineList);

  // 更新凭证头状态
  public abstract void updateFinVoucherHeadForStatus(
      Integer voucherHeadId, String voucherHeadCode, String status);

  // 更新凭证审批状态
  public abstract void updateFinVoucherHeadForApproveStatus(
      Integer voucherHeadId, String approveStatus);
