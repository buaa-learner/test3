...
/**
 * Creates a Map for each Attributes result with attribute names as keys and Lists of Attribute
 * values for values.
 *
...
class AttributeMapAttributesMapper implements AttributesMapper {
  ...
  public Object mapFromAttributes(Attributes attributes) throws NamingException {
    ...
    for (final NamingEnumeration<? extends Attribute> attributesEnum = attributes.getAll();
        attributesEnum.hasMore(); ) {
  ...
  /**
   * Create a Map instance to be used as attribute map. <br>
