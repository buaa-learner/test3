...
public class ProvideCasLoginTicketAction extends AbstractAction {
  ...
  @NotNull private UniqueTicketIdGenerator ticketIdGenerator;
  ...
  protected Event doExecute(RequestContext context) throws Exception {
    ...
    if (request.getParameter("lt_flag") != null
        && request.getParameter("lt_flag").equalsIgnoreCase("true")
        && request.getParameter("cas_client_key") != null
        && request.getParameter("cas_client_key").equals("aph2_cas_redragon")) {
