...
public class InvStockCheckHeadServiceImpl implements InvStockCheckHeadService {
  ...
  // 注入Dao
  @Autowired private InvStockCheckHeadDao invStockCheckHeadDao;
  ...
  @Override
  public List<InvStockCheckHead> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, InvStockCheckHeadCO paramObj) {
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    ...
    if (approveStatus.equals("APPROVE")) {
      ...
      // 获取行
      List<InvStockCheckLine> lineList =
          this.invStockCheckLineService.getInvStockCheckLineListByHeadCode(code);
  ...
  @Override
  public void insertOrUpdateStockCheck(
      InvStockCheckHead invStockCheckHead, List<InvStockCheckLine> invStockCheckLineList) {
    // 保存头
