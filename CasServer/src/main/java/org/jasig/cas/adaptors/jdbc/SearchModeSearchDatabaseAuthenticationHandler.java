...
/**
 * Class that given a table, username field and password field will query a database table with the
 * provided encryption technique to see if the user exists. This class defaults to a
 * PasswordTranslator of PlainTextPasswordTranslator.
 *
...
public class SearchModeSearchDatabaseAuthenticationHandler
    extends AbstractJdbcUsernamePasswordAuthenticationHandler implements InitializingBean {
