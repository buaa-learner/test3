...
public class ApPayLineDaoImpl implements ApPayLineDao {
  ...
  public List<ApPayLine> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, ApPayLineCO paramObj) {
    return null;
  }
  ...
  public Double getInvoicePaidAmount(String invoiceHeadCode, Integer payLineId) {
    String sql =
        "select sum(l.invoice_pay_amount) from ap_pay_line l where l.invoice_head_code = :code and"
            + " l.pay_line_id <> :id";
