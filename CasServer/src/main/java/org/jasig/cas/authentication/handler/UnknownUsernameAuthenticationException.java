...
public class UnknownUsernameAuthenticationException
  ...
  public static final UnknownUsernameAuthenticationException ERROR =
      new UnknownUsernameAuthenticationException();
  ...
  private static final String CODE =
      "error.authentication.credentials.bad.usernameorpassword.username";

  /**
   * Default constructor that does not allow the chaining of exceptions and uses the default code as
  ...
  /**
   * Constructor that allows for the chaining of exceptions. Defaults to the default code provided
   * for this exception.
   *
  ...
  /**
   * Constructor that allows for providing a custom error code for this class. Error codes are often
   * used to resolve exceptions into messages. Providing a custom error code allows the use of a
   * different message.
   *
