...
/**
 * Default implementation of the {@link ServicesManager} interface. If there are no services
 * registered with the server, it considers the ServicecsManager disabled and will not prevent any
 * service from using CAS.
 *
...
public final class DefaultServicesManagerImpl implements ReloadableServicesManager {
  ...
  @NotNull private ServiceRegistryDao serviceRegistryDao;
   ...
   * RegisteredService can include a set of default attributes to use if no services are defined in
   * the registry.
   *
  ...
  /**
   * {@inheritDoc} Note, if the repository is empty, this implementation will return a default
   * service to grant all access.
   *
   * <p>This preserves default CAS behavior.
   */
  @Override
