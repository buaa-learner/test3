...
public class FinVoucherBillRWebController extends ControllerSupport {
  ...
  public String getFinVoucherBillRList(
      Pages pages, FinVoucherBillRCO finVoucherBillRCO, Model model) {
    // TODO: 分页查询数据
    if (pages.getPage() == 0) {
      pages.setPage(1);
    }
    ...
    // 分页查询数据
    List<FinVoucherBillR> finVoucherBillRList =
  ...
  public String editFinVoucherBillR(
      @Valid FinVoucherBillR finVoucherBillR,
