...
/**
 * Uses a List of {@link IAdditionalDescriptors} objects to delegate method calls to. For
 * set/add/remove operations all delegates are called. For get operations the first delegate to
 * return a non-null/empty result is used.
 *
...
public class MediatingAdditionalDescriptors implements IAdditionalDescriptors {
  ...
  public void setDelegateDescriptors(List<IAdditionalDescriptors> delegateDescriptors) {
    Validate.noNullElements(
        delegateDescriptors, "delegateDescriptors List cannot be null or contain null attributes");
   ...
   *
   * @see
   *     org.jasig.services.persondir.support.IAdditionalDescriptors#removeAttribute(java.lang.String)
   */
   ...
   *
   * @see
   *     org.jasig.services.persondir.support.IAdditionalDescriptors#setAttributeValues(java.lang.String,
   *     java.util.List)
   */
