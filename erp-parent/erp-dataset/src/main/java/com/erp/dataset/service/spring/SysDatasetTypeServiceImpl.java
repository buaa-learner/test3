...
public class SysDatasetTypeServiceImpl implements SysDatasetTypeService {
  ...
  // 注入Dao
  @Autowired private SysDatasetTypeDao sysDatasetTypeDao;
  ...
  @Override
  public List<SysDatasetType> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, SysDatasetTypeCO paramObj) {
