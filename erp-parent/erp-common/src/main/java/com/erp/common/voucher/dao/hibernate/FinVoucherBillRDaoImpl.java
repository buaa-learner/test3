...
public class FinVoucherBillRDaoImpl implements FinVoucherBillRDao {
  ...
  public List<FinVoucherBillR> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, FinVoucherBillRCO paramObj) {
    return null;
  }
  ...
  public String getVoucherHeadCodeByBillHeadCode(String billType, String billHeadCode) {
    String sql =
        "select voucher_head_code from fin_voucher_bill_r where bill_head_code = :billHeadCode and"
            + " bill_type = :billType";
  ...
  public boolean isExistVoucherRelateArPay(String headCode) {
    String sql =
        "select count(*) from fin_voucher_bill_r h where h.bill_type = 'PAY' and h.bill_head_code ="
            + " :headCode";
  ...
  public boolean isExistVoucherRelateArReceipt(String headCode) {
    String sql =
        "select count(*) from fin_voucher_bill_r h where h.bill_type = 'RECEIPT' and"
            + " h.bill_head_code = :headCode";
