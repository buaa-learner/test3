...
public class MdVendorBankWebController extends ControllerSupport {
  ...
  @ResponseBody
  public String editMdVendorBank(
      @Valid @RequestBody MdVendorBank mdVendorBank,
  ...
  @ResponseBody
  public String deleteMdVendorBank(
      @RequestBody MdVendorBank mdVendorBank, RedirectAttributes attr) {
    try {
      // 删除数据前验证数据
      if (mdVendorBank != null && mdVendorBank.getBankId() != null) {
        // 删除数据
