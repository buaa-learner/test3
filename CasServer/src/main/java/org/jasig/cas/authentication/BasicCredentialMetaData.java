...
/**
 * Basic credential metadata implementation that stores the original credential ID and the original
 * credential type. This can be used as a simple converter for any {@link Credential} that doesn't
 * implement {@link CredentialMetaData}.
 *
