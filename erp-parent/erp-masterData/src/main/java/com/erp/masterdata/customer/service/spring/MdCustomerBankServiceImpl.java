...
public class MdCustomerBankServiceImpl implements MdCustomerBankService {
  ...
  // 注入Dao
  @Autowired private MdCustomerBankDao mdCustomerBankDao;
  ...
  @Override
  public List<MdCustomerBank> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, MdCustomerBankCO paramObj) {
