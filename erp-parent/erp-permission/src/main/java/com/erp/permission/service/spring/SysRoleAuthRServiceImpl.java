...
public class SysRoleAuthRServiceImpl implements SysRoleAuthRService {
  ...
  // 注入Dao
  @Autowired private SysRoleAuthRDao sysRoleAuthRDao;
  ...
  @Override
  public List<SysRoleAuthR> getDataObjectsForDataAuth(
      String dataAuthSQL, Pages pages, SysRoleAuthRCO paramObj) {
