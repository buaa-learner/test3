...
public class FinVoucherLineDaoImpl implements FinVoucherLineDao {
  ...
  public List<FinVoucherLine> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, FinVoucherLineCO paramObj) {
    return null;
  }
  ...
  public List<FinVoucherLine> getFinVoucherLineListByVoucherHeadCode(String voucherHeadCode) {
    String sql =
        "select l.* from fin_voucher_line l where voucher_head_code = :voucherheadcode order by"
            + " l.voucher_line_id";
  ...
  public BigDecimal getFinVoucherAmountByVoucherHeadCode(String voucherHeadCode) {
    String sql =
        "select sum(l.dr_amount) from fin_voucher_line l where l.voucher_head_code ="
            + " :voucherheadcode";
  ...
  public List<FinVoucherLine> getVoucherLineList(String billType, String billHeadCode) {
    String sql =
        "select l.* from fin_voucher_line l,fin_voucher_bill_r b "
