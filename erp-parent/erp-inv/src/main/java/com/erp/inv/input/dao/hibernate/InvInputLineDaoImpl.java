...
public class InvInputLineDaoImpl implements InvInputLineDao {
  ...
  public List<InvInputLine> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, InvInputLineCO paramObj) {
    return null;
  }

  @Override
  public List<InvInputLine> getInvInputLineListByInputHeadCode(
      Pages pages, InvInputLineCO paramObj) {
  ...
  public Double getInputQuantityByPoLineCode(String poLineCode) {
    String sql =
        "select sum(l.input_quantity) from inv_input_line l where l.input_source_line_code ="
            + " :poLineCode";
  ...
  public Double getInputedQuantityByPoLine(String poLineCode, Integer inputLineId) {
    String sql =
        "select sum(l.input_quantity) from inv_input_line l where l.input_source_line_code = :code"
            + " and l.input_line_id <> :id";
