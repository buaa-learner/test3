...
public class MdFinanceSubjectWebController extends ControllerSupport {
  ...
  // 服务层注入
  @Autowired private MdFinanceSubjectService mdFinanceSubjectService;
  ...
  public String getMdFinanceSubjectList(
      Pages pages, MdFinanceSubjectCO mdFinanceSubjectCO, Model model) {
  ...
  public String getMdFinanceSubjectTreeData(String nodeId) {
    // 获取科目列表
    List<MdFinanceSubject> list =
        this.mdFinanceSubjectService.getDataObjects(new MdFinanceSubjectCO());
    // 根节点
  ...
  private List<TreeNode> getAllChildrenNode(
      MdFinanceSubject currentObj, List<MdFinanceSubject> list, Map<String, TreeNode> treeNodeMap) {
  ...
  public String getMdFinanceSubjectEditModal(String nodeId, Model model) {
    ...
    if (StringUtils.isNotBlank(nodeId)) {
      MdFinanceSubject parentNode =
          this.mdFinanceSubjectService.getDataObject(Integer.parseInt(nodeId));
  ...
  public String getMdFinanceSubject(MdFinanceSubject mdFinanceSubject, Model model) {
    ...
    if (mdFinanceSubject != null && mdFinanceSubject.getSubjectId() != null) {
      mdFinanceSubject =
          this.mdFinanceSubjectService.getDataObject(mdFinanceSubject.getSubjectId());
  ...
  @ResponseBody
  public String editMdFinanceSubject(
      @Valid @RequestBody MdFinanceSubject obj,
    ...
    try {
      ...
      if (StringUtils.isBlank(parentId)) {
        ...
        // 获取父节点
        MdFinanceSubject parentNode =
            this.mdFinanceSubjectService.getDataObject(Integer.parseInt(parentId));
