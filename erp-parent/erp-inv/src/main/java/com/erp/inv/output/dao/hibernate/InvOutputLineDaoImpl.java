...
public class InvOutputLineDaoImpl implements InvOutputLineDao {
  ...
  public List<InvOutputLine> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, InvOutputLineCO paramObj) {
    return null;
  }
  ...
  public Double getOutputQuantityBySoLineCode(String soLineCode) {
    String sql =
        "select sum(l.output_quantity) from inv_output_line l where l.output_source_line_code ="
            + " :soLineCode";
