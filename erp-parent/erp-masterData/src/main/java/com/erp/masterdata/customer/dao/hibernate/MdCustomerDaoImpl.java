...
public class MdCustomerDaoImpl implements MdCustomerDao {
  ...
  public List<MdCustomer> getDataObjectsForDataAuth(
      @SqlParam String dataAuthSQL, Pages pages, MdCustomerCO paramObj) {
    return null;
  }
  ...
  public List<MdCustomer> getMdCustomerListForOwn() {
    String sql =
        "select c.* from md_customer c where c.own_flag = 'Y' and c.status = 'Y' and"
            + " c.approve_status = 'APPROVE' order by c.customer_id desc";
  ...
  public void updateApproveStatus(String code, String approveStatus) {
    String sql =
        "update md_customer set approve_status = :approveStatus where customer_code = :code";
